...
- [x] 1. Block Kit Builder の実装

  - [x] 1.1 Block Kit Builder の基本構造を作成
...
- [x] 2. チェックポイント - Block Kit Builder

  - すべてのテストが通ることを確認
  - 不明点があればユーザーに確認

- [x] 3. Slack Handler の実装

  - [x] 3.1 Slack Handler の基本構造を作成
  ...
  - [x] 3.5 インタラクションパース機能を実装

    - `parse_interaction()` メソッドを実装
    - ペイロードの JSON パース
    - _Requirements: 3.4_

  - [x] 3.6 ブロックアクション処理を実装
...
- [x] 4. チェックポイント - Slack Handler

  - すべてのテストが通ることを確認
  - 不明点があればユーザーに確認

- [x] 5. Slack Notifier の実装

  - [x] 5.1 Slack Notifier の基本構造を作成
...
- [x] 6. チェックポイント - Slack Notifier

  - すべてのテストが通ることを確認
  - 不明点があればユーザーに確認

- [x] 7. Webhook Lambda の実装

  - [x] 7.1 Lambda 関数の基本構造を作成
...
- [x] 8. チェックポイント - Webhook Lambda

  - すべてのテストが通ることを確認
  - 不明点があればユーザーに確認

- [x] 9. CDK Construct の実装

  - [x] 9.1 Slack Construct の基本構造を作成

    - `lib/constructs/notification/slack-construct.ts` を作成
    - Props インターフェースの定義
    - _Requirements: 9.1, 9.4_

  - [x] 9.2 API Gateway の設定
  ...
  - [x] 9.4 DynamoDB テーブルの設定

    - SlackMessageRecord テーブルの作成
    - _Requirements: 5.1, 5.2, 5.3_

  - [x] 9.5 Secrets Manager の設定
    - Slack Signing Secret の管理
    - _Requirements: 7.1, 7.2, 7.3_

- [x] 10. チェックポイント - CDK Construct
